...
return [
    ...
    | ukuran. Jangan ragu untuk memodifikasi setiap pesan ini di sini.
    |
    */
    ...
    | konvensi "attribute.rule" untuk penamaan baris. Ini membuat lebih mudah
    | untuk menentukan pesan kustom yang spesifik untuk aturan atribut tertentu.
    |
    */
    ...
    'custom' => [
        ...
        'tunggakan' => [
            'required' => 'Tunggakan harus diisi.',
            'numeric' => 'Tunggakan harus berupa angka.',
        ],
        'area' => [
